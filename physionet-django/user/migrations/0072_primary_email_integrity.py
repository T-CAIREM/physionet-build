...
def restore_primary_emails(apps, schema_editor):
    ...
    unverified primary emails.

    Promote the associated email matching the user's email field. For users
    with a single associated email, promote it and realign the user's email
    field. Users with no associated emails at all cannot be repaired here.
    """
